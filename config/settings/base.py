...
# GNOSISSCAN_API_KEY = env("GNOSISSCAN_API_KEY", default="")
# LINEASCAN_API_KEY = env("LINEASCAN_API_KEY", default="")

DISCORD_WEBHOOK_AJNA_NOTIFICATIONS = env("DISCORD_WEBHOOK_AJNA_NOTIFICATIONS", default="")
