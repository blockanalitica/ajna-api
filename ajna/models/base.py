...
class PoolBase(models.Model):
    ...
    debt = models.DecimalField(max_digits=40, decimal_places=18)
...
class AuctionKick(models.Model):
    ...
    kick_momp = models.DecimalField(max_digits=32, decimal_places=18, null=True)
    reference_price = models.DecimalField(max_digits=32, decimal_places=18, null=True)
