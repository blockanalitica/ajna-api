...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ajna', '0100_v4avalancheactivitysnapshot_v4avalancheauction_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='V4LineaActivitySnapshot',
            fields=[
        ...
        migrations.CreateModel(
            name='V4LineaAuctionAuctionNFTSettle',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='V4LineaAuctionAuctionSettle',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_index', models.CharField(max_length=26, unique=True)),
                ('auction_uid', models.TextField()),
        ...
        migrations.CreateModel(
            name='V4LineaReserveAuctionKick',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_index', models.CharField(max_length=26, unique=True)),
        ...
        migrations.CreateModel(
            name='V4LineaReserveAuctionTake',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_index', models.CharField(max_length=26, unique=True)),
                ('reserve_auction_uid', models.TextField()),
        ...
        migrations.CreateModel(
            name='V4LineaCurrentWalletPoolPosition',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['pool_address', 'bucket_index', 'block_number'], name='ajna_v4line_pool_ad_f59b23_idx'), models.Index(fields=['pool_address', 'bucket_index'], name='ajna_v4line_pool_ad_9a2a0b_idx'), models.Index(fields=['pool_address'], name='ajna_v4line_pool_ad_d88620_idx'), models.Index(fields=['bucket_index'], name='ajna_v4line_bucket__781206_idx'), models.Index(fields=['block_number'], name='ajna_v4line_block_n_d17d42_idx'), models.Index(fields=['block_datetime'], name='ajna_v4line_block_d_54c76a_idx')],
                'unique_together': {('pool_address', 'bucket_index', 'block_number')},
            },
        ),
        migrations.CreateModel(
            name='V4LineaPoolEvent',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pool_address', models.CharField(max_length=42)),
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['pool_address', 'order_index'], name='ajna_v4line_pool_ad_2b64aa_idx'), models.Index(fields=['pool_address', 'wallet_addresses', 'order_index'], name='ajna_v4line_pool_ad_27b630_idx'), models.Index(fields=['pool_address', 'wallet_addresses'], name='ajna_v4line_pool_ad_554296_idx'), models.Index(fields=['pool_address'], name='ajna_v4line_pool_ad_882393_idx'), models.Index(fields=['order_index'], name='ajna_v4line_order_i_3a2cdc_idx')],
                'unique_together': {('pool_address', 'order_index')},
            },
        ),
        migrations.CreateModel(
            name='V4LineaPoolSnapshot',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('erc', models.CharField(choices=[('erc20', 'erc20'), ('erc721', 'erc721')], max_length=10, null=True)),
                ('pool_size', models.DecimalField(decimal_places=18, max_digits=32)),
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['address', 'datetime'], name='ajna_v4line_address_f13085_idx'), models.Index(fields=['datetime'], name='ajna_v4line_datetim_f5b854_idx')],
                'unique_together': {('address', 'datetime')},
            },
        ),
        migrations.CreateModel(
            name='V4LineaPoolVolumeSnapshot',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pool_address', models.CharField(db_index=True, max_length=42)),
                ('amount', models.DecimalField(decimal_places=18, max_digits=32)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'get_latest_by': 'datetime',
                'abstract': False,
                'indexes': [models.Index(fields=['underlying_address'], name='ajna_v4line_underly_f98906_idx'), models.Index(fields=['timestamp'], name='ajna_v4line_timesta_782a61_idx'), models.Index(fields=['datetime'], name='ajna_v4line_datetim_f754e9_idx'), models.Index(fields=['underlying_address', 'datetime'], name='ajna_v4line_underly_92a584_idx')],
            },
        ),
        migrations.CreateModel(
            name='V4LineaWalletPoolBucketState',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['pool_address', 'wallet_address', 'bucket_index', 'block_number'], name='ajna_v4line_pool_ad_663ea5_idx'), models.Index(fields=['pool_address', 'wallet_address', 'bucket_index'], name='ajna_v4line_pool_ad_efa8c8_idx'), models.Index(fields=['pool_address'], name='ajna_v4line_pool_ad_953fa4_idx'), models.Index(fields=['wallet_address'], name='ajna_v4line_wallet__217090_idx'), models.Index(fields=['bucket_index'], name='ajna_v4line_bucket__089b0e_idx'), models.Index(fields=['block_number'], name='ajna_v4line_block_n_053130_idx'), models.Index(fields=['block_datetime'], name='ajna_v4line_block_d_00a9bf_idx')],
                'unique_together': {('pool_address', 'wallet_address', 'bucket_index', 'block_number')},
            },
        ),
        migrations.CreateModel(
            name='V4LineaWalletPoolPosition',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('wallet_address', models.CharField(db_index=True, max_length=42)),
                ('pool_address', models.CharField(db_index=True, max_length=42)),
