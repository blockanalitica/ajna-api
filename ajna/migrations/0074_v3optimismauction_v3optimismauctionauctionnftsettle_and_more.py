# Generated by Django 4.2.3 on 2024-01-05 17:08
...
class Migration(migrations.Migration):
    dependencies = [
        ("ajna", "0073_v3arbitrumauction_v3arbitrumauctionauctionnftsettle_and_more"),
    ]

    operations = [
        migrations.CreateModel(
            name="V3OptimismAuction",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3OptimismAuctionAuctionNFTSettle",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3OptimismAuctionAuctionSettle",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3OptimismAuctionBucketTake",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3OptimismReserveAuctionKick",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3OptimismReserveAuctionTake",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3OptimismWalletPoolPosition",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3OptimismWalletPoolBucketState",
            fields=[
                (
                    "id",
                    models.BigAutoField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3opti_pool_ad_1482b4_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_address", "bucket_index"],
                        name="ajna_v3opti_pool_ad_215d87_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3opti_pool_ad_09b1ae_idx"
                    ),
                    models.Index(
                        fields=["wallet_address"], name="ajna_v3opti_wallet__e065d6_idx"
                    ),
                    models.Index(
                        fields=["bucket_index"], name="ajna_v3opti_bucket__538643_idx"
                    ),
                    models.Index(
                        fields=["block_number"], name="ajna_v3opti_block_n_5034e8_idx"
                    ),
                    models.Index(
                        fields=["block_datetime"], name="ajna_v3opti_block_d_31f2e9_idx"
                    ),
                ],
                "unique_together": {
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3opti_underly_6a49d7_idx",
                    ),
                    models.Index(
                        fields=["timestamp"], name="ajna_v3opti_timesta_d24704_idx"
                    ),
                    models.Index(
                        fields=["datetime"], name="ajna_v3opti_datetim_98081e_idx"
                    ),
                    models.Index(
                        fields=["underlying_address", "datetime"],
                        name="ajna_v3opti_underly_4da7e3_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            name="V3OptimismPoolVolumeSnapshot",
            fields=[
                (
                    "id",
                    models.BigAutoField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3opti_pool_ad_14aa99_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_addresses", "order_index"],
                        name="ajna_v3opti_pool_ad_08801a_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_addresses"],
                        name="ajna_v3opti_pool_ad_da0c3c_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3opti_pool_ad_05c947_idx"
                    ),
                    models.Index(
                        fields=["order_index"], name="ajna_v3opti_order_i_f738bc_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            name="V3OptimismPoolBucketState",
            fields=[
                (
                    "id",
                    models.BigAutoField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3opti_pool_ad_6100fd_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "bucket_index"],
                        name="ajna_v3opti_pool_ad_481efa_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3opti_pool_ad_a8c2fc_idx"
                    ),
                    models.Index(
                        fields=["bucket_index"], name="ajna_v3opti_bucket__de69ef_idx"
                    ),
                    models.Index(
                        fields=["block_number"], name="ajna_v3opti_block_n_2d3b3c_idx"
                    ),
                    models.Index(
                        fields=["block_datetime"], name="ajna_v3opti_block_d_9137ce_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            name="V3OptimismCurrentWalletPoolPosition",
            fields=[
                (
                    "id",
                    models.BigAutoField(
