# Generated by Django 4.2.3 on 2024-01-05 17:22
...
class Migration(migrations.Migration):
    dependencies = [
        ("ajna", "0074_v3optimismauction_v3optimismauctionauctionnftsettle_and_more"),
    ]

    operations = [
        migrations.CreateModel(
            name="V3PolygonAuction",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3PolygonAuctionAuctionNFTSettle",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3PolygonAuctionAuctionSettle",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3PolygonAuctionBucketTake",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3PolygonReserveAuctionKick",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3PolygonReserveAuctionTake",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3PolygonWalletPoolPosition",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3PolygonWalletPoolBucketState",
            fields=[
                (
                    "id",
                    models.BigAutoField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3poly_pool_ad_1816b0_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_address", "bucket_index"],
                        name="ajna_v3poly_pool_ad_f6b9d0_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3poly_pool_ad_1bda7c_idx"
                    ),
                    models.Index(
                        fields=["wallet_address"], name="ajna_v3poly_wallet__509efc_idx"
                    ),
                    models.Index(
                        fields=["bucket_index"], name="ajna_v3poly_bucket__c637d9_idx"
                    ),
                    models.Index(
                        fields=["block_number"], name="ajna_v3poly_block_n_eba88f_idx"
                    ),
                    models.Index(
                        fields=["block_datetime"], name="ajna_v3poly_block_d_0729f5_idx"
                    ),
                ],
                "unique_together": {
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3poly_underly_90f87e_idx",
                    ),
                    models.Index(
                        fields=["timestamp"], name="ajna_v3poly_timesta_bab525_idx"
                    ),
                    models.Index(
                        fields=["datetime"], name="ajna_v3poly_datetim_b66b63_idx"
                    ),
                    models.Index(
                        fields=["underlying_address", "datetime"],
                        name="ajna_v3poly_underly_9fa198_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            name="V3PolygonPoolVolumeSnapshot",
            fields=[
                (
                    "id",
                    models.BigAutoField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3poly_pool_ad_88cc2c_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_addresses", "order_index"],
                        name="ajna_v3poly_pool_ad_9315de_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_addresses"],
                        name="ajna_v3poly_pool_ad_3e0078_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3poly_pool_ad_600f12_idx"
                    ),
                    models.Index(
                        fields=["order_index"], name="ajna_v3poly_order_i_45fa34_idx"
                    ),
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3poly_pool_ad_160ae0_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "bucket_index"],
                        name="ajna_v3poly_pool_ad_304410_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3poly_pool_ad_aa7941_idx"
                    ),
                    models.Index(
                        fields=["bucket_index"], name="ajna_v3poly_bucket__2a6eb6_idx"
                    ),
                    models.Index(
                        fields=["block_number"], name="ajna_v3poly_block_n_b8c4c9_idx"
                    ),
                    models.Index(
                        fields=["block_datetime"], name="ajna_v3poly_block_d_9fa448_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            name="V3PolygonCurrentWalletPoolPosition",
            fields=[
                (
                    "id",
                    models.BigAutoField(
