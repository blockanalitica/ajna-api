# Generated by Django 4.2.3 on 2023-12-21 10:17
...
class Migration(migrations.Migration):
    dependencies = [
        ("ajna", "0071_v3ethereumauction_v3ethereumauctionauctionnftsettle_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="V3BaseAuctionAuctionNFTSettle",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3BaseAuctionAuctionSettle",
            fields=[
                (
                    "id",
                    models.BigAutoField(
        ...
        migrations.CreateModel(
            name="V3BaseWalletPoolBucketState",
            fields=[
                (
                    "id",
                    models.BigAutoField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3base_pool_ad_142f5c_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_address", "bucket_index"],
                        name="ajna_v3base_pool_ad_d48a91_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3base_pool_ad_a5baf3_idx"
                    ),
                    models.Index(
                        fields=["wallet_address"], name="ajna_v3base_wallet__1ad94a_idx"
                    ),
                    models.Index(
                        fields=["bucket_index"], name="ajna_v3base_bucket__5ed28d_idx"
                    ),
                    models.Index(
                        fields=["block_number"], name="ajna_v3base_block_n_047262_idx"
                    ),
                    models.Index(
                        fields=["block_datetime"], name="ajna_v3base_block_d_dde301_idx"
                    ),
                ],
                "unique_together": {
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3base_underly_1f0259_idx",
                    ),
                    models.Index(
                        fields=["timestamp"], name="ajna_v3base_timesta_35a5c2_idx"
                    ),
                    models.Index(
                        fields=["datetime"], name="ajna_v3base_datetim_e9c464_idx"
                    ),
                    models.Index(
                        fields=["underlying_address", "datetime"],
                        name="ajna_v3base_underly_31d8fe_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            name="V3BasePoolVolumeSnapshot",
            fields=[
                (
                    "id",
                    models.BigAutoField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3base_pool_ad_3a7562_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_addresses", "order_index"],
                        name="ajna_v3base_pool_ad_1b8d93_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "wallet_addresses"],
                        name="ajna_v3base_pool_ad_bf6913_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3base_pool_ad_afa515_idx"
                    ),
                    models.Index(
                        fields=["order_index"], name="ajna_v3base_order_i_925932_idx"
                    ),
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="ajna_v3base_pool_ad_7b8d0d_idx",
                    ),
                    models.Index(
                        fields=["pool_address", "bucket_index"],
                        name="ajna_v3base_pool_ad_1d6fcc_idx",
                    ),
                    models.Index(
                        fields=["pool_address"], name="ajna_v3base_pool_ad_cdd21d_idx"
                    ),
                    models.Index(
                        fields=["bucket_index"], name="ajna_v3base_bucket__b766a7_idx"
                    ),
                    models.Index(
                        fields=["block_number"], name="ajna_v3base_block_n_80c234_idx"
                    ),
                    models.Index(
                        fields=["block_datetime"], name="ajna_v3base_block_d_f9b553_idx"
                    ),
                ],
        ...
        migrations.CreateModel(
            name="V3BaseCurrentWalletPoolPosition",
            fields=[
                (
                    "id",
                    models.BigAutoField(
